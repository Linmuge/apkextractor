 ...
 * 基于主色 #4285F4 (Google Blue) 生成
 * 用于不支持动态取色的设备 (Android 12 以下)
 */

// Light Theme Colors
val md_theme_light_primary = Color(0xFF4285F4)
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFD8E7FF)
...
val md_theme_light_tertiaryContainer = Color(0xFFFBD7FD)
...
val md_theme_dark_primaryContainer = Color(0xFF1A4A83)
...
val md_theme_dark_tertiaryContainer = Color(0xFF563D5C)
val md_theme_dark_onTertiaryContainer = Color(0xFFFBD7FD)
...
val ChartColor1 = Color(0xFF4285F4)
val ChartColor2 = Color(0xFF34A853)
val ChartColor3 = Color(0xFFFBBC05)
val ChartColor4 = Color(0xFFEA4335)
val ChartColor5 = Color(0xFF9C27B0)
val ChartColor6 = Color(0xFF00BCD4)
