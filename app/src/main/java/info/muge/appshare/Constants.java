...
public class Constants {
    ...
    public static final String ACTION_REFRESH_APP_LIST="info.muge.appshare.refresh_applist";
    public static final String ACTION_REFRESH_IMPORT_ITEMS_LIST="info.muge.appshare.refresh_import_items_list";
    public static final String ACTION_REFRESH_AVAILIBLE_STORAGE="info.muge.appshare.refresh_storage";
